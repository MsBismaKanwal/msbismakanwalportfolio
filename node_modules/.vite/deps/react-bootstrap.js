import {
  require_react_dom
} from "./chunk-CL24GV5I.js";
import {
  DEFAULT_BREAKPOINTS,
  DEFAULT_MIN_BREAKPOINT,
  InputGroupText_default,
...
var divWithClassName_default = ((className) => (
  ...
  React15.forwardRef((p, ref) => (0, import_jsx_runtime9.jsx)("div", {
    ...p,
    ref,
...
var FormCheck = React73.forwardRef(({
  ...
  const innerFormContext = (0, import_react54.useMemo)(() => ({
...
var FormGroup = React76.forwardRef(({
  ...
  const context6 = (0, import_react56.useMemo)(() => ({
    controlId
  }), [controlId]);
...
function useMergedRefs2(refA, refB) {
  return (0, import_react61.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
function useNavItem({
  ...
  const navContext = (0, import_react62.useContext)(NavContext_default);
...
var Nav = React87.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react63.useRef)(false);
  ...
  const listNode = (0, import_react63.useRef)(null);
...
function useCallbackRef2() {
  return (0, import_react64.useState)(null);
}
...
function useUpdatedRef2(value) {
  const valueRef = (0, import_react65.useRef)(value);
  valueRef.current = value;
  return valueRef;
}
...
function useWillUnmount2(fn2) {
  ...
  (0, import_react66.useEffect)(() => () => onUnmount.current(), []);
}
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react67.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const child = (0, import_react68.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react69.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react69.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react69.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react69.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react69.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react69.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react69.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react69.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
function useTransition({
  ...
  const isInitialRef = (0, import_react70.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react70.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react70.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react71.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react71.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react71.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react71.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react71.useState)(!show);
  const lastFocusRef = (0, import_react71.useRef)(null);
  (0, import_react71.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react71.useRef)();
  const removeKeydownListenerRef = (0, import_react71.useRef)();
  ...
  return (0, import_jsx_runtime83.jsx)(import_jsx_runtime83.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime83.jsxs)(import_jsx_runtime83.Fragment, {
...
var AbstractModalHeader = React97.forwardRef(({
  ...
  const context6 = (0, import_react72.useContext)(ModalContext_default);
...
var ModalHeader = React98.forwardRef(({
  ...
  return (0, import_jsx_runtime89.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime91.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal2 = React100.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react73.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react73.useState)(false);
  const waitingForMouseUpRef = (0, import_react73.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react73.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react73.useRef)(null);
  const [modal, setModalRef] = useCallbackRef2();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react73.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react73.useCallback)((backdropProps) => (0, import_jsx_runtime91.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime91.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime91.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime91.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime91.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var Nav2 = React103.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react74.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react74.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime94.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
...
var NavbarCollapse = React105.forwardRef(({
  ...
  const context6 = (0, import_react75.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime96.jsx)(Collapse_default, {
...
var NavbarToggle = React106.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react76.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime97.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime97.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react77.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react78.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasToggling = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var OffcanvasHeader = React109.forwardRef(({
  ...
  return (0, import_jsx_runtime100.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime102.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime102.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React111.forwardRef(({
  ...
  const modalManager = (0, import_react79.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react79.useState)(false);
  const handleHide = useEventCallback(onHide);
  const hideResponsiveOffcanvas = useBreakpoint_default(responsive || "xs", "up");
  (0, import_react79.useEffect)(() => {
    setShowOffcanvas(responsive ? show && !hideResponsiveOffcanvas : show);
  }, [show, responsive, hideResponsiveOffcanvas]);
  const modalContext = (0, import_react79.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  function getModalManager() {
    if (propsManager) return propsManager;
  ...
  const renderBackdrop = (0, import_react79.useCallback)((backdropProps) => (0, import_jsx_runtime102.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames77.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime102.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime104.jsxs)(import_jsx_runtime103.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime102.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime102.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React112.forwardRef(({
  ...
  const context6 = (0, import_react80.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context6 == null || context6.onToggle == null || context6.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime105.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React114.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react81.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react81.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime107.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React115.forwardRef(({
  ...
  return (0, import_jsx_runtime109.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames80.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime108.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var Overlay = React116.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react83.useState)(!props.show);
...
var Popover = React120.forwardRef(({
  ...
  return (0, import_jsx_runtime113.jsxs)("div", {
    ...
    ...props,
    children: [(0, import_jsx_runtime112.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime112.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Overlay2 = React122.forwardRef(({
  ...
  const popperRef = (0, import_react85.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react85.useState)(null);
  ...
  return (0, import_jsx_runtime116.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  const handleShow = (0, import_react86.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react86.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react86.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react86.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react86.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react86.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react86.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime119.jsxs)(import_jsx_runtime118.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react86.cloneElement)(children, triggerProps), (0, import_jsx_runtime117.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React124.forwardRef(({
  ...
  return (0, import_jsx_runtime120.jsx)("li", {
    ref,
    style: style2,
    ...
    children: (0, import_jsx_runtime121.jsxs)(Component2, {
      className: (0, import_classnames86.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime120.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React124.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime121.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React125.forwardRef(({
  ...
  return (0, import_jsx_runtime122.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React126.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime123.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var ProgressBar = React128.forwardRef(({
  ...
  return (0, import_jsx_runtime125.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react87.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react88.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react89.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react89.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabPane = React137.forwardRef(({
  ...
  return (0, import_jsx_runtime136.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime136.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime136.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var ToastFade = React140.forwardRef((props, ref) => (0, import_jsx_runtime140.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React142.forwardRef(({
  ...
  const context6 = (0, import_react90.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React144.forwardRef(({
  ...
  const delayRef = (0, import_react91.useRef)(delay);
  const onCloseRef = (0, import_react91.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react91.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react91.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  return (0, import_jsx_runtime144.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime144.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
